...
if(NOT TARGET freetype)
    if(WIN32)
        ...
        if(ANDROID AND EXISTS "${CPPMODULE_ROOTPATH}/libpng/CMakeLists.txt")
            ...
            cppmodule_add_subdirectory(libpng "${CPPMODULE_ROOTPATH}/libpng")
            ...
            if(TARGET freetype AND TARGET png_static)
                ...
                target_link_libraries(freetype PUBLIC png_static)
            endif()
        else()
            ...
            cppmodule_add_subdirectory(freetype2 "${CPPMODULE_ROOTPATH}/freetype2")
            if(PNG_FOUND)
                message(STATUS "FreeType PNG: Enable")
            else()
                message(STATUS "FreeType PNG: Disable")
            endif()
        endif()
    endif()
endif()
