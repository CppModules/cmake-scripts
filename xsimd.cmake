...
if(NOT TARGET cppmodule::xsimd)
  ...
  if(MSVC)
      ...
      if(XSIMD_HAS_AVX2)
          target_compile_options(cppmodule::xsimd INTERFACE $<$<COMPILE_LANGUAGE:CXX>:/arch:AVX2>)
      else()
          check_cxx_compiler_flag("/arch:AVX" XSIMD_HAS_AVX)
          if(XSIMD_HAS_AVX)
              target_compile_options(cppmodule::xsimd INTERFACE $<$<COMPILE_LANGUAGE:CXX>:/arch:AVX>)
          endif()
      endif()
  else()
      # GCC / Clang 环境下
